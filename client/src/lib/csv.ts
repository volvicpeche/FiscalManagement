...
export const AVERTISSEMENTS = [
  ...
  'LMNP : l exception des residences services (etudiants, seniors, EHPAD) a la reintegration des amortissements n est pas modelisee. Le micro-BIC bascule au reel l annee qui suit un depassement de seuil.',
  'LMNP meuble de tourisme au-dela de 23 000 EUR : cotisations SSI a taux forfaitaire indicatif, sans le detail des assiettes et abattements de l URSSAF. Au reel, les cotisations au-dela du resultat ne creent pas de deficit.',
  'Mobilier amorti sur une duree unique de 7 ans et suppose sans valeur a la revente. Il n est pas renouvele sur l horizon.',
